...
# Get the Data
# We'll be working with the csv file from the assignment. It has the info of 'Delivery Time' and 'Sorting Time'.
#
dataset = pd.read_csv("/Users/Ankan/PycharmProjects/Basiccode/1. Assignments/4. Simple Linear Regression - Done/delivery_time.csv")
...
sns.jointplot(data = dataset, x = 'Sorting Time', y='Delivery Time')
plt.show()

sns.jointplot(x = 'Sorting Time', y='Delivery Time', kind='hex',data=dataset)
plt.show()

sns.pairplot(dataset,height= 2)
plt.show()

sns.lmplot(x = 'Sorting Time', y='Delivery Time',data=dataset)
plt.show()
...
print(cdf)
   ...
   ######## Holding all other features fixed, a 1 unit increase in **Sorting Time** ##########
   ######## Is associated with an **increase of (1.648835) **. ##########
...
# x1 = newdata1[['Sorting Time']]
# y1 = newdata1['Delivery Time']
#
